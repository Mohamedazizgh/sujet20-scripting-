...
yad --title "HARDWARE INFOS" --form --separator="" --width=400 --height=200  --text-align=center --text="<span foreground='blue'><b><big><big> HARDWARE INFOS </big></big></b></span> \n \n \n Notre application sert à detecter le hardware de votre pc mais aussi donner les users disponible et fournir avec la commande -mtop les 5 processus les plus gourmands de votre mémoire, cela permettra aussi d'afficher une courbe avec -plot ou -gnuplot pour vous faciliter l'analyse" \
